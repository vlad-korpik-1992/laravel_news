            ...
            <div class="col-12">
                <form action="{{ route('admin.post.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input class="form-control w-25" type="text" name="title" placeholder="Название поста" value="{{ old('title') }}">
                        @error('title')
                    ...
                    <input class="btn btn-block btn-primary w-25" type="submit" value="Добавить">
                </form>
            </div>
        </div>
        <!-- /.row -->
